...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="active capitalize">  Following </li>
        </ol>
    </div>
</div> 
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 m-b-20">
        <div class="row m-b-20">
            <div class="col-xs-12">
                <h2 class="page-title capitalize no-margin"><b>Following</b></h2>
                <p>Use the 'Follow' link or icon to subscribe to topics or forums and never miss another moment.</p>
            </div>
        </div>
                    ...
                    <div class="row m-b-10">
                        <div class="col-lg-5 col-md-8 col-sm-8 col-xs-8 nodata_box">
                            ...
                            <div class="nodata_box_content text-left">
                                <h4><b>Someone was here, I can feel it!</b></h4>
                                <p>Find your answers, start your first post...</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-6 m-b-20">
                            <div class="no_timeline_img pull-right">
                                <img src="{{ asset($image_path.'following_img.png') }}">
                            </div>
                        </div>
