...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="active capitalize"> {{$data['tag_name']}} </li>
        </ol>
    </div>
</div> 
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="row m-b-20">
            <div class="col-xs-12">
                <h2 class="page-title capitalize no-margin"><b>{{$data['tag_name']}}</b></h2>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="topicId_{{$topic->ft_id}}">
                        <div class="panel panel-default custom_panel">
                            ...
                            <div class="panel-wrapper collapse in">
                                ...
                                <div class="panel-footer b-none"></div>
                            </div>
                        </div>
                    </div>
                </div>
