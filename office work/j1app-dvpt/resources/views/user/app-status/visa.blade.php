@php
    ...
    $converted_data = @$step_verified_data['converted_data'];
    $embassy_timezone_converted = @$converted_data->dest_timezone_id;
    $embassy_date_converted = @$converted_data->dest_datetime;
...
<div class="row">
    <div class="col-sm-12 visa_status_form">
        ...
        <div>
            ...
            <!-- <p>Check our forum for latest. You will get other candidates feedback on the interview and some cool tips to help you during the interview.</p>
            <ul class="list-style-none m-b-20">
                <li><a href="#">8 Expert TSA Tips To Get Through Airport Security Faster</a></li>
                <li><a href="#">10 Ways to Survive a Long-Haul Flight</a></li>
                <li><a href="#">15 Smart Travel Packing Tip</a></li>
            </ul> -->
...
<!--                                <button type="submit" name="visa_status" class="btn btn-info" value="visa_approved">Yes</button>
                            <button type="submit" name="visa_status" class="btn btn-info" value="visa_denied">No</button>-->
            ...
            <div id="visa_status_form">
                <form name="frm_visa_status" id="frm_visa_status">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group text-center mtop15">
                            <button type="submit" name="visa_status" id="reschedule_appointment" class="btn btn-info" value="reschedule_appointment" onclick="frmsubmit(this.value)">Schedule Another J1 Visa Appointment</button>
                            <button type="submit" name="visa_status" id="quit_program" class="btn btn-danger" value="quit_program" onclick="frmsubmit(this.value)">Quit Program</button>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group text-center mtop15">
                            <button type="submit" name="visa_status" id="visa_denied_undo" class="btn" value="visa_denied_undo" onclick="frmsubmit(this.value)">Undo Visa Denied</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    function frmsubmit(submit_btn)
    {
        if(submit_btn == "visa_denied"){
            ...
            confirmAlert(msg,"warning","Confirm","Confirm",submit_visa_form(submit_btn))
        }
    ...
    function submit_visa_form(submit_btn){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                {
                    setTimeout(function(){
                        loadStepContent('3_us_embassy_interview');
                    },1000);
                }
                else
                {
                    setTimeout(function(){
                        loadStepContent('3_us_visa_outcome');
                    },3000);
                }
            },
        });
